...
(function() {
    ...
    const welcomeScreenHTML = `
        ...
        <div class="user-registration">
            ...
            <form class="registration-form">
                ...
                <div class="form-field">
                    <label class="form-label" for="chat-user-phone-number">Nomor Hp</label>
                    <input type="text" id="chat-user-phone-number" class="form-input" placeholder="Your Phone Number" required>
                    <div class="error-text" id="phone-number-error"></div>
                </div>
    ...
    const phoneNumberInput = chatWindow.querySelector('#chat-user-phone-number');
    const nameError = chatWindow.querySelector('#name-error');
    const phoneNumberError = chatWindow.querySelector('#phone-number-error');
